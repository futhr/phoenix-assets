...
</script><Story name="Static or graph projection"><DocShell {presentation} currentId="intro" currentPath="/docs/intro" audiences={["developer", "admin"]} locales={["en", "de"]} /></Story>
